...
//     // Read cart at the TOP level of build() — safe outer context
...
// import 'home_data.dart';
//
// // ── Trending Card — UNCHANGED from original working version ──────────────────
// class TrendingCard extends StatelessWidget {
//   final TrendingProduct product;
//   const TrendingCard({super.key, required this.product});
//
...
//
// // ── New Arrival Card ──────────────────────────────────────────────────────────
// // Uses mainAxisSize: min so it sizes to content — no fixed height needed.
// // The ListView in home_screen sets height: 230 which is enough.
...
//         mainAxisSize: MainAxisSize.min,
//         children: [
//           // ── IMAGE (100px — leaves enough room for text + pill) ─
//           Stack(
//             children: [
//               ClipRRect(
//                 borderRadius:
...
//               qty: qty,
//               onDecrement: () =>
//                   cart.decrement(cartItem!.id, cartItem.quantity),
//               onIncrement: () =>
//                   cart.increment(cartItem!.id, cartItem.quantity),
//             ),
//           ),
//         ],
//       ),
...
// }
//
// // ── Exotics Card — identical layout to NewArrivalCard ────────────────────────
// class ExoticsCard extends StatelessWidget {
//   final NewArrivalProduct product;
//   const ExoticsCard({super.key, required this.product});
//
//   @override
//   Widget build(BuildContext context) {
//     final cart = context.watch<CartProvider>();
