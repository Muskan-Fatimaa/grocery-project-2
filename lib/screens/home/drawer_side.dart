...
//
//     // Clear providers — stops Firestore listeners and clears local data
//     context.read<CartProvider>().reset();
//     context.read<WishlistProvider>().reset();
//
//     // Sign out — AuthGate StreamBuilder fires and shows SignIn automatically
...
//             // ── Header ────────────────────────────────────────────────────
//             DrawerHeader(
//               decoration: const BoxDecoration(color: Color(0xffe07b39)),
//               child: Row(
...
//                       children: [
//                         Text(
//                           user != null ? 'Welcome!' : 'Welcome Guest',
//                           style: const TextStyle(
...
//                 Navigator.push(
//                   context,
//                   // ✅ const removed — MyProfileScreen uses FirebaseAuth
//                   // and SharedPreferences so it cannot be const
