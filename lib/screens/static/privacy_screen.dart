...
//                   body:
//                   'We collect personal information you provide directly, such as your name, email, phone number, and delivery address. We also automatically collect usage data including device information, IP address, and in-app interactions to improve our service.',
//                 ),
//                 _PrivacySection(
//                   title: '2. How We Use Your Information',
//                   body:
//                   'We use your information to process orders, send delivery updates, improve our app, personalise your shopping experience, and communicate promotions. We do not sell your data to third parties.',
//                 ),
//                 _PrivacySection(
//                   title: '3. Data Sharing',
//                   body:
//                   'We may share your information with delivery partners and payment processors solely to fulfil your orders. These partners are bound by confidentiality agreements and may not use your data for any other purpose.',
//                 ),
//                 _PrivacySection(
//                   title: '4. Data Security',
//                   body:
//                   'We use industry-standard encryption (TLS) and secure Firebase infrastructure to protect your data in transit and at rest. Access to personal data is restricted to authorised personnel only.',
//                 ),
//                 _PrivacySection(
//                   title: '5. Cookies & Tracking',
//                   body:
//                   'Our app may use analytics tools to understand user behaviour. These tools collect anonymised aggregate data. You can opt out of analytics tracking through your device settings.',
//                 ),
//                 _PrivacySection(
//                   title: '6. Your Rights',
//                   body:
//                   'You have the right to access, update, or delete your personal information at any time from your profile settings. You may also request a complete copy of your data by contacting our support team.',
//                 ),
//                 _PrivacySection(
//                   title: "7. Children's Privacy",
//                   body:
//                   'Our service is not directed to individuals under the age of 13. We do not knowingly collect personal information from children. If we discover such data has been collected, we will delete it promptly.',
//                 ),
//                 _PrivacySection(
//                   title: '8. Changes to This Policy',
//                   body:
//                   'We may update this Privacy Policy from time to time. We will notify you of significant changes via the app or email. Continued use after such notice constitutes your acceptance of the updated policy.',
//                 ),
//                 _PrivacySection(
//                   title: '9. Contact',
//                   body:
//                   'For privacy-related inquiries, contact our Data Protection Officer at privacy@groceryapp.pk or through the Help section within the app.',
//                 ),
//               ],
//             ),
//           ),
