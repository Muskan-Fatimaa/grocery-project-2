...
//   //
//   // Creates (or updates) users/{uid} with basic profile info.
//   // Uses merge: true so existing fields are not overwritten.
//   //
//   // Call this once after a successful sign-in from main.dart / AuthGate.
...
//         // createdAt is only written on first login (merge won't overwrite it)
//       },
//       SetOptions(merge: true), // safe to call on every login
//     );
//
//     // Write createdAt only if the document is new (field doesn't exist yet)
...
// ── COMPLETE REPLACEMENT — paste over your existing firestore_service.dart ──
